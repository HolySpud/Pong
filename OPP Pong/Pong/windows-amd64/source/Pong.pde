...
void setup() { //Start
  ...
  //Constructors
  gameBall = new Ball(width/2, height/2, height/25, height/25, width, height, #ffffff); // (X, Y, W, H, Width, Height, Color)
  rightPaddle = new Paddle(width - width/50, height/2, width/50, height/4, #a9a9a9, 'i', 'k'); // (X, Y, W, H, Color, Up Key, Down Key)
  leftPaddle = new Paddle(0, height/2, width/50, height/4, #a9a9a9, 'w', 's'); // (X, Y, W, H, Color, Up Key, Down Key)
